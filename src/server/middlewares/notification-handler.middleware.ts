...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Support Ticket Submission.create': { roles: ['hr-manager'], key: 'support_ticket', tenantPath: [], userPath: [] },
  'Leave Request Submission.create': {
    roles: ['hr-manager', 'payroll-administrator'],
    key: 'leave_request',
    tenantPath: [],
    userPath: [],
  },
  'Payroll Schedule Update.update': {
...
const ownerRoles: string[] = ['hr-manager'];
const customerRoles: string[] = ['customer'];
const tenantRoles: string[] = ['hr-manager', 'employee', 'payroll-administrator'];
