...
import { getHrManagers, deleteHrManagerById } from 'apiSdk/hr-managers';
...
export function HrManagerListPage(props: HrManagerListPageProps) {
  ...
  const { data, error, isLoading, mutate } = useSWR<PaginatedInterface<HrManagerInterface>>(
    () => `/hr-managers?params=${JSON.stringify(params)}`,
    fetcher,
  );
